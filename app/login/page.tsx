...
export default function Login({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center">
      ...
      <div className="h-32 p-9 text-center mt-[100px]">
        <Label className={`text-6xl ${sacramento.className}`}>Quote Keeper</Label>
      </div>
      <div className="flex flex-col w-[400px] px-8 sm:max-w-md justify-center gap-2">
        <Link
          href="/"
        ...
        <Card className="w-[350px] ml-6">
          ...
          <CardContent>
            <form className="flex flex-col w-full text-foreground m-auto">
